...
During migration, `source` preserves the original Wix URL. A post is only marked `ready` after its text, embeds, images, alt text, downloadable files, and internal links have been checked.
